...
def Obtain_n (MasterProtein, dicc_fasta,clean_seq,m) : 
    ...
    #MasterProtein= MasterProtein[0]+"_"+MasterProtein[1] # The id is extracted from the Master Protein name 
    #final_q_pos = ""
    #print(MasterProtein, dicc_fasta)
...
def main(file,infile1,fastafile):
    ...
    df2 = pd.DataFrame(columns=["p","pdm","q","pd","d","Theo_mh","ScanFreq","a","m","n","l","b","e","f","K","qdna","qna","A","M","L","N","qdNA"],dtype=float) # Dataframe 2 is created with the aim of 
    ...
    for q in dic_qna_p_sort:
        ...
        #print(sorted_q_b_e_qna,"sorted_q_b_e_qna")
        p_number = 0 
        dic_qna_cluster[q]={}
        ...
        for p in sorted_q_b_e_qna: 
            ...
            if sorted_q_b_e_qna[p][0]<min_nb:
                ...
                for element in lista: 
                    #print(lista,str(clusterb)+"-"+str(clustere) )
